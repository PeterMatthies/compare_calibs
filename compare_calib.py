...
new_filename = '2016-10-14-closed-2D-Qmagnet.txt'
#old_filename = '2016-09-23-pol-xy-axis-QMagnet.txt'
...
fig.suptitle('Calibration Comparison\n flux closed ', fontsize=12, fontweight='bold')

x_voltage_calib = fig.add_subplot(221)
x_voltage_calib.plot(new_xv, new_xv_field, c='green', label=new_filename[0:10])
...
x_current_calib.plot(new_xc, new_xc_field, c='green', label=new_filename[0:10])
...
# plt.savefig('nopol_fc_old_fo_new_magnet_compare_calibrations.eps', format='eps', dpi=1000)
plt.savefig('newest_closed_magnet_compare_calibrations_2.png', format='png', dpi=1000)
plt.show()
